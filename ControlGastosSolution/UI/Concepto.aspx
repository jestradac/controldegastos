                        ...
                        <div class="card-content collpase show">
                            <div class="card-body">
                                <div class="form form-horizontal">
                                    <div class="form-body">
                                        <h4 class="form-section"><i class="icon-wallet"></i>Registro de Concepto</h4>
                                        <div class="form-group row">
                                            <label class="col-md-3 label-control" for="projectinput1">Nombre</label>
                                            <div class="col-md-9">
                                                <asp:TextBox ID="txbNombre" class="form-control" placeholder="Nombre del Concepto" name="fname" MaxLength="50" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-3 label-control" for="projectinput6">Tipo de Transacción</label>
                                            <div class="col-md-9">
                                                <asp:DropDownList class="form-control" ID="ddlTipoTransaccion" runat="server">
